...
export function SplashScreen() {
  return (
    <section className="relative flex min-h-screen items-center justify-center p-6">
      ...
      >
        <p className="font-mono text-xs uppercase tracking-[0.2em] text-cyan-300">DB Rank Systems</p>
        <h1 className="mt-3 font-mono text-4xl text-white text-neon">SQL IRL</h1>
        <p className="mt-2 text-sm text-cyan-100/80">Initializing your database avatar...</p>
